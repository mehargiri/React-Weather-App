export default function RainDrop({ fill, className }) {
	return (
		<svg
			fill={fill}
			className={className}
		...
		>
			<g>
				<g>
					<path
						d="M413.602,225.145L256,0L98.398,225.145c-31.625,45.18-41.04,101.519-25.833,154.574C87.582,432.109,140.105,512,256,512
